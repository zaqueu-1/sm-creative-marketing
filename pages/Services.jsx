  ...
  return (
    <div className='services-container'>
      ...
      <div data-aos={"fade-up"} data-aos-duration={"1500"} className="services-icons">
        <Image className='service-icon' src={require('../public/images/1.png')} alt='image' width='200' height='200' />
        <Image className='service-icon' src={require('../public/images/2.png')} alt='image' width='200' height='200' />
        <Image className='service-icon' src={require('../public/images/3.png')} alt='image' width='200' height='200' />
        <Image className='service-icon' src={require('../public/images/4.png')} alt='image' width='200' height='200' />
        <Image className='service-icon' src={require('../public/images/5.png')} alt='image' width='200' height='200' />
      </div>
      </div>
    </div>
  )
